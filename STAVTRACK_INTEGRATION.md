...
В проект добавлен отдельный TCP-приёмник:
...
2. В Settings -> Deploy поставить Custom Start Command:
...
4. Settings -> Networking -> Public Networking -> `+ TCP Proxy`.
5. Internal Port указать:

```text
9000
```

6. Railway выдаст адрес и порт вида:
